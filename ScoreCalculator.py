...
def payload_fraction_scoring(N):
  ...
  return maximum_payload_fraction_scoring 
...
def write_into_txt(total_score,maneuverability_scoring,max_range_lap_scoring,payload_fract_scoring,bonus_score,total_range):
...
def run():
  ...
  payload_fract_scoring = payload_fraction_scoring(N)
  bonus_score = bonus_scoring()
  total_score = maneuverability_scoring + max_range_lap_scoring + payload_fract_scoring + bonus_score
  ...
  write_into_txt(total_score,maneuverability_scoring,max_range_lap_scoring,payload_fract_scoring,bonus_score,total_range)
